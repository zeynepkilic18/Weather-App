...
extension Color {
    static let background = LinearGradient(gradient: Gradient(colors: [Color("Background 1"), Color("Background 2")]), startPoint: .topLeading, endPoint: .bottomTrailing)
        ...
        static let weatherTabBarBorder = Color("Tab Bar Border").opacity(0.5)
        static let weatherForecastCardBackground = Color("Forecast Card Background")
        static let weatherProbabilityText = Color("Probability Text")
    }
